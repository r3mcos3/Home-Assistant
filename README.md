...
[![Home Assistant](https://img.shields.io/badge/Home%20Assistant-2026.9.0-41BDF5.svg?style=flat-square&logo=home-assistant)](https://www.home-assistant.io/)
...
This configuration runs on **Home Assistant 2026.9.0** (stable version) and uses a mix of official integrations and custom components to create a fully automated smart home experience.
